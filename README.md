...
|912|[Sort an Array](https://leetcode.com/problems/sort-an-array/)|Python3|Medium|Implement sorting algorithm without built-in functions.<br>[Merge Sort](./solutions/python3/SortAnArray1.py)<br>[Heap Sort](./solutions/python3/SortAnArray2.py)<br>[Counting Sort](./solutions/python3/SortAnArray3.py)|
